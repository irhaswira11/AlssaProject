...
def search_placement():
    ...
    project_name = st.text_input('Project Name', placeholder="ex : Instalasi Jaringan")
...
def manage_data():
    ...
    if data_type == "Employees":
        ...
        name = st.text_input('Initial Name', placeholder="ex : IN, RR", key='input_name')
        ...
        for i, certification in enumerate(certifications):
            with st.expander(certification):
                ...
                if st.button(f"Delete Certification {certification}", key=f"delete_cert_{i}"):
                    ...
                    st.rerun()
        new_certification = st.text_input('Add new certification', placeholder="ex : Sertifikasi - Kompetensi",key='input_certification')
        ...
        for i, skill in enumerate(skills):
            with st.expander(skill):
                ...
                if st.button(f"Delete Skill {skill}", key=f"delete_skill_{i}"):
                    ...
                    st.rerun()
        new_skill = st.text_input('Add new skill', placeholder="ex : Engineer",key='input_skill')
